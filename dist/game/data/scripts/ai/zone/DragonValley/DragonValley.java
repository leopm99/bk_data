...
public final class DragonValley extends AbstractNpcAI
{
	...
	{
		CLASS_POINTS.put(ClassId.adventurer, 29);
		CLASS_POINTS.put(ClassId.arcanaLord, 22);
		CLASS_POINTS.put(ClassId.archmage, 29);
		CLASS_POINTS.put(ClassId.cardinal, 29);
		CLASS_POINTS.put(ClassId.dominator, 28);
		CLASS_POINTS.put(ClassId.doombringer, 33);
		CLASS_POINTS.put(ClassId.doomcryer, 31);
		CLASS_POINTS.put(ClassId.dreadnought, 27);
		CLASS_POINTS.put(ClassId.duelist, 25);
		CLASS_POINTS.put(ClassId.elementalMaster, 30);
		CLASS_POINTS.put(ClassId.evaSaint, 29);
		CLASS_POINTS.put(ClassId.evaTemplar, 24);
		CLASS_POINTS.put(ClassId.femaleSoulhound, 31);
		CLASS_POINTS.put(ClassId.fortuneSeeker, 27);
		CLASS_POINTS.put(ClassId.ghostHunter, 28);
		CLASS_POINTS.put(ClassId.ghostSentinel, 31);
		CLASS_POINTS.put(ClassId.grandKhavatari, 29);
		CLASS_POINTS.put(ClassId.hellKnight, 32);
		CLASS_POINTS.put(ClassId.hierophant, 28);
		CLASS_POINTS.put(ClassId.judicator, 23);
		CLASS_POINTS.put(ClassId.moonlightSentinel, 30);
		CLASS_POINTS.put(ClassId.maestro, 29);
		CLASS_POINTS.put(ClassId.maleSoulhound, 21);
		...
		CLASS_POINTS.put(ClassId.titan, 32);
		CLASS_POINTS.put(ClassId.trickster, 25);
		CLASS_POINTS.put(ClassId.windRider, 29);
	}
